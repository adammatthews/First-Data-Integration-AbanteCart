<?php
	...
	$exclude_settings = array(
		...
		'FirstData_status',
		'FirstData_logoimg',
		'FirstData_cartbordercolor',
	);

	if ( !$this->config->get('FirstData_logoimg') ) {
		$custom_logo = 'resources/' . $this->config->get('config_logo');
		$this->config->set('FirstData_logoimg', $custom_logo);
	} else {
		$custom_logo = $this->config->get('FirstData_logoimg');
	}
...
<div class="fieldset">
	...
	<div class="fieldset">
		...
		<div class="cont_left"><div class="cont_right"><div class="cont_mid">
			...
			<table>
				<tr>
					<td width="150" style="padding-right: 40px;"><img src="<?php echo HTTP_EXT . 'FirstData/image/all_in_one_solution_logo_u2645_normal.gif'; ?>"/></td>
					...
					<td style="padding-right: 10px;"><?php echo $settings['FirstData_status']['note']; ?></td>
					<td class="ml_field"><?php echo $settings['FirstData_status']['value']; ?></td>
				</tr>
			</table>
					    		...
					    		<div class="aform_noaction">
					    			<div class="afield mask1">
					    				<div class="cl"><div class="cr"><div class="cc">
					    					<input id="FirstData_confirm_email" class="atext " type="text" ovalue="" value="" name="FirstData_confirm_email">
					    				</div></div></div>
					    			</div>
					    		</div>
					    	</span>
	...
	<div class="cont_left"><div class="cont_right"><div class="cont_mid">
		<div class="flt_left">
			<table class="form">
				...
				<tr>
					<td><?php echo $settings['FirstData_logoimg']['note']; ?></td>
					<td class="ml_field">
						...
						<span class="text_element">
							...
							<div class="aform"><div class="afield mask1"><div class="cl"><div class="cr"><div class="cc">
								...
								<input type="text" name="FirstData_logoimg" id="FirstData_logoimg" class="atext " value="<?php echo $custom_logo; ?>" ovalue="0"  />
				...
				<tr>
					<td><?php echo $settings['FirstData_cartbordercolor']['note']; ?></td>
					<td class="ml_field"><?php echo $settings['FirstData_cartbordercolor']['value']; ?></td>
					<td></td>
				</tr>
			</table>
		</div>
		<div class="flt_left" style="margin-left: 20px;">
			<img src="<?php echo HTTP_EXT . 'FirstData/image/customize_help.png'; ?>" />
		</div>
...
<?php } ?>
	...
	$('#FirstData_confirm_email').val($('#FirstData_email').val());

	$('#editSettings').submit(function() {
		if ( $('#FirstData_confirm_email').val() != $('#FirstData_email').val() ) {
			$(document).scrollTop( $('#FirstData_confirm_email').offset().top );
